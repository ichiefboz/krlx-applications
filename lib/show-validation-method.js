Meteor.methods({
	finalValidateShow: function(showID) {
		...
		if(show.type != "Bandemonium") {
			...
			if(show.description == null || show.description.length < 25) throw new Meteor.Error("show-validation-err-3", "Show validation error (code 3)", "You need to provide a description of your show. Please provide one in step 3 (content) and try submitting your application again.");
